...
const messages = defineMessages('components.Settings.Notifications', {
  ...
  usePublicLogo: 'Use public logo instead of instance logo',
  usePublicLogoTip:
    'If your Loom instance is not publicly accessible, enable this option so email clients outside your network can display the image. The image will be pulled from the public GitHub repository.',
