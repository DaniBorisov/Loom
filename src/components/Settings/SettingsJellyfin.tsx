...
const messages = defineMessages('components.Settings', {
  ...
  jellyfinSyncFailedConnectionError:
    'Unable to reach the {mediaServerName} server. Check that it is running and reachable from Loom.',
  ...
  manualscanDescriptionJellyfin:
    "Normally, this will only be run once every 24 hours. Loom will check your {mediaServerName} server's recently added more aggressively. If this is your first time configuring Loom, a one-time full manual library scan is recommended!",
