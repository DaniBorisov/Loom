...
const messages = defineMessages('components.Settings', {
  ...
  plexsettingsDescription:
    'Configure the settings for your Plex server. Loom scans your Plex libraries to determine content availability.',
  serverpreset: 'Server',
  serverLocal: 'local',
  serverRemote: 'remote',
  serverSecure: 'secure',
  ...
  plexlibrariesDescription:
    'The libraries Loom scans for titles. Set up and save your Plex connection settings, then click the button below if no libraries are listed.',
  scanning: 'Syncing…',
  scan: 'Sync Libraries',
  manualscan: 'Manual Library Scan',
  manualscanDescription:
    "Normally, this will only be run once every 24 hours. Loom will check your Plex server's recently added more aggressively. If this is your first time configuring Plex, a one-time full manual library scan is recommended!",
  ...
  tautulliSettingsDescription:
    'Optionally configure the settings for your Tautulli server. Loom fetches watch history data for your Plex media from Tautulli.',
  urlBase: 'URL Base',
