...
const messages: { [messageName: string]: MessageDescriptor } = defineMessages(
  'components.Settings.SettingsJobsCache',
  {
    ...
    jobs: 'Jobs',
    jobsDescription:
      'Loom performs certain maintenance tasks as regularly-scheduled jobs, but they can also be manually triggered below. Manually running a job will not alter its schedule.',
    jobname: 'Job Name',
    jobtype: 'Type',
    ...
    cache: 'Cache',
    cacheDescription:
      'Loom caches requests to external API endpoints to optimize performance and avoid making unnecessary API calls.',
    ...
    dnsCache: 'DNS Cache',
    dnsCacheDescription:
      'Loom caches DNS lookups to optimize performance and avoid making unnecessary API calls.',
    ...
    imagecacheDescription:
      'When enabled in settings, Loom will proxy and cache images from pre-configured external sources. Cached images are saved into your config folder. You can find the files in <code>{appDataPath}/cache/images</code>.',
