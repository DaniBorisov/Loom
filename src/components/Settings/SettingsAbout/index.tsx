...
const messages = defineMessages('components.Settings.SettingsAbout', {
  ...
  runningDevelop:
    'You are running the <code>develop</code> branch of Loom, which is only recommended for those contributing to development or assisting with bleeding-edge testing.',
});
