...
const messages = defineMessages('components.Settings.SettingsNetwork', {
  ...
  networksettingsDescription:
    'Configure network settings for your Loom instance.',
  ...
  trustProxyTip:
    'Allow Loom to correctly register client IP addresses behind a proxy',
  ...
  forceIpv4FirstTip:
    'Force Loom to resolve IPv4 addresses first instead of IPv6',
  dnsCache: 'DNS Cache',
  dnsCacheTip:
