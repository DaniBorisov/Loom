...
import {
  ...
  LanguageIcon as FilledLanguageIcon,
...
const MobileMenu = ({
  ...
  const menuLinks: MenuLink[] = [
    ...
    },
    {
      ...
      svgIcon: <LanguageIcon className="h-6 w-6" />,
      svgIconSelected: <FilledLanguageIcon className="h-6 w-6" />,
    ...
    },
    {
      ...
      activeRegExp: /^\/discover\/favorites/,
    },
    {
