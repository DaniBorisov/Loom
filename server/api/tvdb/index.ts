...
class Tvdb extends ExternalAPI implements TvShowProvider {
  ...
  async login(): Promise<TvdbLoginResponse> {
    // Compliance note (DAN-114, docs/compliance.md): this shared
    // application-wide key is inherited from Seerr/Jellyseerr and confirmed
    // legitimate for fork usage. Do not swap in a different/personal key
    // without revisiting — compliant status depends on this specific key.
